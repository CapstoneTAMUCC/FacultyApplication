...
var require = {
	app: {
		analytics: true,
		copyright: "2015 by Necati Username",
		deployType: "development",
		description: "",
		guid: "b2b29ce4-d0ae-40c9-9222-48e6029f02af",
		id: "com.tamucc.NecatiTest2",
		name: "NecatiTest2",
		names: {},
		publisher: "Necati Username",
		url: "http://",
		version: "1.0"
	},
	has: {
...
require("Ti/App/Properties", function(p) {
	...
	p.setString("appc-app-id","56207dc694ad6408124edd3f");
	...
	p.setString("acs-oauth-secret-development","iCISIMmplJ0GaAIpbu0dwr4hVZSHPAA8");
	p.setString("acs-oauth-key-development","b5XrvK2cCYuiKfpHhPEbtS6A3dEB5h4V");
	p.setString("acs-api-key-development","AQBUxaKgnrmZ4ShiyouOkuDaYF3ZeiRl");
	p.setString("acs-username-development","appc_app_user_dev");
	p.setString("acs-password-development","MuISzp70AmRQrYEnk7");
	...
	p.setString("acs-oauth-secret-production","iWxGS5Q3C30aQ4ek95cuDE4eewsoagjy");
	p.setString("acs-oauth-key-production","tldTEdYffpqFV0AimXFGe6ac2o0e206M");
	p.setString("acs-api-key-production","nx4yW6zyjxKneHdTnMeDb8HYr7VJ4mh6");
	p.setString("acs-username-production","appc_app_user");
	p.setString("acs-password-production","FBrpWzp1wvTAk0sugB");
	p.setString("appc-org-id","100074127");
	p.setString("appc-creator-user-id","2fad1c2b-1dee-4e46-881a-0fcc98628d7e");
});
