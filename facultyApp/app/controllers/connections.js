	...
	if(users) {
		...
		if(OS_IOS) {
			$.wrapper2.addEventListener("swipe", function(e){
				...
				if(e.direction === "right"){
					$.listView2.sectionIndexTitles = null;
				}
			});
		}
	}
...
onSearchChange2 = function onChange(e){
	$.listView2.searchText = e.source.value;
};
...
if(OS_IOS){
	...
	$.listView2.addEventListener("editaction", onRowAction);
}
